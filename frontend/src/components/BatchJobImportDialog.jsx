...
import { Upload, FileText, CheckCircle2, XCircle, Loader2, Play, Trash2, ChevronRight, Briefcase } from 'lucide-react'
...
export default function BatchJobImportDialog({ open = true, onClose, onImported }) {
  ...
  return (
    <Modal
      ...
      size="lg"
      icon={Briefcase}
      title={t('batch_job_import.title')}
      subtitle={t('batch_job_import.subtitle')}
